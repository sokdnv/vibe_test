...
def format_for_telegram(hook: str, body: str, cta: str) -> str:
    return f"*{hook}*\n\n{body}\n\n_{cta}_"


def format_for_instagram(hook: str, body: str, cta: str) -> str:
    bold_hook = _to_unicode_bold(hook)
    italic_cta = _to_unicode_italic(cta)
    return f"{bold_hook}\n\n✦ ✦ ✦\n\n{body}\n\n— {italic_cta}"
